...
Note:
* Microsoft Excel or equivalent spreadsheet software is required to open .xls files.
...
* Sequential template files (.xls) containing the information about the Community Profile template, such as information about the sequential numbers and data labels, the table descriptions, and the population that is being counted
* Metadata file (.xls) containing information on the table numbers, names, populations and cell descriptor information
